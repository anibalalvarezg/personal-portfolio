...
export const professionalExperienceEn = [
  ...
  },
  {
    ...
    descriptions: [
      "Development of frontend modules in Angular 11+, with Bootstrap and SCSS styles, focused on scalability and component reusability within a monorepo shared between two projects, facilitating code integration and consistency.",
